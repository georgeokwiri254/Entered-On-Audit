"""
Booking.com Email Parser for INNLINK2WAY System
Handles specific extraction and calculation logic for T-Booking.com reservations
"""
...
class BookingComParser:
    """Parser specifically for Booking.com (T-Booking.com) emails via INNLINK2WAY"""
    
    def __init__(self):
        """Initialize with Booking.com specific regex patterns"""
        self.patterns = {
    ...
    def parse_booking_com_email(self, email_content: str, sender_email: str = "") -> Dict[str, Any]:
        """
        Parse Booking.com email content and extract reservation fields
        Apply T-Booking.com specific business logic
        """
        extracted = {}
        ...
        # Set company information - Booking.com specific
        extracted['C_T_S'] = "T- Booking.com"
        extracted['C_T_S_NAME'] = "T- Booking.com"
        extracted['COMPANY'] = "T- Booking.com"
        
        # ** T-BOOKING.COM SPECIFIC AMOUNT CALCULATIONS **
        total_charges = extracted.get('TOTAL_CHARGES', 'N/A')
        nights = extracted.get('NIGHTS', 'N/A')
        
        if total_charges != 'N/A' and nights != 'N/A':
            try:
                # Parse total charges (this is MAIL_TOTAL for T-Booking.com)
                ...
                # For T-Booking.com: MAIL_TOTAL = email amount (includes TDF)
                ...
                # Calculate ADR (Average Daily Rate) = AMOUNT / NIGHTS
                if nights_num > 0:
                ...
                extracted['ADR_AED'] = f"AED {adr:,.2f}" if nights_num > 0 else "N/A"
    ...
    def test_extraction(self, email_content: str, sender_email: str = "") -> Dict[str, Any]:
        ...
        extracted = self.parse_booking_com_email(email_content, sender_email)
...
def test_booking_com_parser():
    """Test function for the Booking.com parser"""
    print("Booking.com Parser Test")
    print("=" * 50)
    
    # Sample email content (you can replace with actual content)
    sample_content = """
    Guest Name: KAPIL SHARMA
    Arrive: 09/04/2025
    Depart: 10/03/2025
    ...
    Superior Room
    Rate Code: WH07918R
    Rate Name: Weekend Special
    Travel Agent
    Name: Booking.com
    Total charges: AED 10,357.47
    Confirman: 4K76RP0X8
    """
