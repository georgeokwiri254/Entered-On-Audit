"""
Expedia Email Parser for INNLINK2WAY System
Handles specific extraction and calculation logic for T-Expedia reservations
"""
...
class ExpediaParser:
    """Parser specifically for Expedia (T-Expedia) emails via INNLINK2WAY"""
    
    def __init__(self):
        """Initialize with Expedia specific regex patterns"""
        self.patterns = {
    ...
    def parse_expedia_email(self, email_content: str, sender_email: str = "") -> Dict[str, Any]:
        """
        Parse Expedia email content and extract reservation fields
        Apply T-Expedia specific business logic
        """
        extracted = {}
        ...
        # Set company information - Expedia specific
        extracted['C_T_S'] = "T- Expedia"
        extracted['C_T_S_NAME'] = "T- Expedia"
        extracted['COMPANY'] = "T- Expedia"
        
        # ** T-EXPEDIA SPECIFIC AMOUNT CALCULATIONS **
        ...
        if net_total_charges != 'N/A' and nights != 'N/A':
            try:
                # Parse net total charges (this is MAIL_NET_TOTAL for T-Expedia - amount WITHOUT TDF)
                ...
                # For T-Expedia: Email amount is MAIL_NET_TOTAL (excludes TDF)
    ...
    def test_extraction(self, email_content: str, sender_email: str = "") -> Dict[str, Any]:
        ...
        extracted = self.parse_expedia_email(email_content, sender_email)
...
def test_expedia_parser():
    """Test function for the Expedia parser"""
    print("T-Expedia Parser Test")
    print("=" * 50)
    ...
    Rate Code: EX123456
    Rate Name: Expedia Special Rate
    Travel Agent
    Name: Expedia
    Total charges: AED 823.20
    Confirman: 4K76RP01M
    """
