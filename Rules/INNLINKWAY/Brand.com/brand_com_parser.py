"""
Brand.com Email Parser for INNLINK2WAY System
Handles specific extraction and calculation logic for Brand.com reservations
Follows T-Booking.com business logic (email amount includes TDF)
"""
...
class BrandComParser:
    """Parser specifically for Brand.com emails via INNLINK2WAY"""
    
    def __init__(self):
        """Initialize with Brand.com specific regex patterns"""
        self.patterns = {
            ...
            'TOTAL_CHARGES': re.compile(r"Total charges:\s*AED\s*([0-9,]+\.?[0-9]*)", re.IGNORECASE),
    ...
    def parse_brand_com_email(self, email_content: str, sender_email: str = "") -> Dict[str, Any]:
        """
        Parse Brand.com email content and extract reservation fields
        Apply Brand.com specific business logic (same as T-Booking.com)
        """
        extracted = {}
        ...
        # Set company information - Brand.com specific
        extracted['C_T_S'] = "Brand.com"
        extracted['C_T_S_NAME'] = "Brand.com"
        extracted['COMPANY'] = "Brand.com"
        
        # ** BRAND.COM SPECIFIC AMOUNT CALCULATIONS **
        # Follows T-Booking.com logic: Email amount is MAIL_TOTAL (includes TDF)
        total_charges = extracted.get('TOTAL_CHARGES', 'N/A')
        nights = extracted.get('NIGHTS', 'N/A')
        
        if total_charges != 'N/A' and nights != 'N/A':
            try:
                # Parse total charges (this is MAIL_TOTAL for Brand.com - includes TDF)
                ...
                # For Brand.com: MAIL_TOTAL = email amount (includes TDF)
    ...
    def test_extraction(self, email_content: str, sender_email: str = "") -> Dict[str, Any]:
        ...
        extracted = self.parse_brand_com_email(email_content, sender_email)
...
def test_brand_com_parser():
    """Test function for the Brand.com parser"""
    print("Brand.com Parser Test")
    print("=" * 50)
    
    # Sample email content
    sample_content = """
    Guest Name: MATE BARANY
    Arrive: 08/28/2025
    Depart: 09/17/2025
    Total Nights 20 nights
    Adult/Children: 1/0
    Room Type: Studio with One King Bed
    Rate Code: UD01607R
    Rate Name: Brand.com Special Rate
    Travel Agent
    Name: CWT UTAZSI IRODA
    Total charges: AED 9,517.10
    Confirman: 4K76RP02A
    """
