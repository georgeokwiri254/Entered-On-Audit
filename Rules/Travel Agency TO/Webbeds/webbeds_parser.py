"""
Webbeds Email Parser
Extracts reservation data from Webbeds confirmation emails
"""

import re
from datetime import datetime

def extract_webbeds_fields(email_body, email_subject):
    """
    Extract reservation fields from Webbeds email content
...
def is_webbeds_email(sender_email, subject):
    """
    Check if email is from Webbeds
    ...
    Returns:
        bool: True if this is a Webbeds email
    """
    return (
        'webbeds' in sender_email.lower() or 
        'webbeds' in subject.lower() or
        'htl-wbd' in subject.lower()
    )
...
if __name__ == "__main__":
    ...
    result = extract_webbeds_fields(sample_email, "HTL-WBD-805981145")
    
    print("Webbeds Extraction Test:")
    print("=" * 50)
