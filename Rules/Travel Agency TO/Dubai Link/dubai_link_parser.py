"""
Dubai Link (Global Travel Engine) Email Parser
Extracts reservation data from Dubai Link confirmation emails
"""

import re
from datetime import datetime

def extract_dubai_link_fields(email_body, email_subject):
    """
    Extract reservation fields from Dubai Link email content
...
def is_dubai_link_email(sender_email, subject):
    """
    Check if email is from Dubai Link
    ...
    Returns:
        bool: True if this is a Dubai Link email
    """
    return (
        'gte.travel' in sender_email.lower() or 
        'dubai link' in subject.lower() or
...
if __name__ == "__main__":
    ...
    result = extract_dubai_link_fields(sample_email, "Confirmed Booking")
    
    print("Dubai Link Extraction Test:")
    print("=" * 50)
