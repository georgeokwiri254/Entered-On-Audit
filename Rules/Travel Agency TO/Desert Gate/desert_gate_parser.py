"""
Desert Gate Parser
Extracts reservation data from Desert Gate booking forms (PDF files or .msg files with PDF attachments)
"""
...
def extract_desert_gate_fields(file_path):
    """
    Extract reservation fields from Desert Gate booking form (.pdf or .msg file)
...
def is_desert_gate_file(file_path):
    """
    Check if file is from Desert Gate
    ...
    try:
        if file_path.lower().endswith('.msg'):
            ...
            with pdfplumber.open(file_path) as pdf:
                ...
                return (
                    'desert gate' in first_page_text.lower() or
                    'dgt' in first_page_text.lower() or
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        result = extract_desert_gate_fields(file_path)
        
        print("Desert Gate File Extraction Test:")
        print("=" * 50)
        ...
        print("Usage: python desert_gate_parser.py <file_path>")