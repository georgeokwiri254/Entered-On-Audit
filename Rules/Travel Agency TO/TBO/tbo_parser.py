"""
TBO Email Parser
Extracts reservation data from TBO confirmation emails
"""

import re
from datetime import datetime

def extract_tbo_fields(email_body, email_subject):
    """
    Extract reservation fields from TBO email content
...
def is_tbo_email(sender_email, subject):
    """
    Check if email is from TBO
    ...
    Returns:
        bool: True if this is a TBO email
    """
    return (
        'tbo' in sender_email.lower() or 
        'tbo' in subject.lower() or
        'elb' in subject.lower()
    )
...
if __name__ == "__main__":
    ...
    result = extract_tbo_fields(sample_email, "Hotel Booking ELB00666401")
    
    print("TBO Extraction Test:")
    print("=" * 50)
